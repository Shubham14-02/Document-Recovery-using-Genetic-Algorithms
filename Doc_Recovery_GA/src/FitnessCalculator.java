...
public class FitnessCalculator{
  ...
  public static void main(String[] args) {
    ...
    System.out.println("The fitness of document1-shredded.txt is PERM3 " + fitness(shreddedDocument, perm3));
    ...
    System.out.println("After unshredding using the correct perm array, the fitness is PERM4: " + fitness(shreddedDocument, perm4));
    ...
    System.out.println("PERM1 The fitness of SillyExample-shredded.txt is: " +fitness(shreddedDocument, perm1));
    System.out.println("Here is what the shredded document looks like");
    prettyPrint(shreddedDocument);

    int[] perm2 = {2,7,6,4,3,1,0,5};
    System.out.println("PERM2 After unshredding using the correct perm array, the fitness is: " + fitness(shreddedDocument, perm2));
